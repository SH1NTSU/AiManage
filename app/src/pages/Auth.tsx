...
import { initiateGitHubOAuth, initiateAppleOAuth, OAUTH_CONFIG } from "@/lib/oauth";
...
const Auth = () => {
  ...
  const hasGoogleOAuth = OAUTH_CONFIG.google.clientId && OAUTH_CONFIG.google.clientId !== 'your_google_client_id_here' && OAUTH_CONFIG.google.clientId !== '';
  const hasGitHubOAuth = OAUTH_CONFIG.github.clientId && OAUTH_CONFIG.github.clientId !== 'your_github_client_id_here' && OAUTH_CONFIG.github.clientId !== '';
  const hasAppleOAuth = OAUTH_CONFIG.apple.clientId && OAUTH_CONFIG.apple.clientId !== 'your_apple_client_id_here' && OAUTH_CONFIG.apple.clientId !== '';
  const hasAnyOAuth = hasGoogleOAuth || hasGitHubOAuth || hasAppleOAuth;
